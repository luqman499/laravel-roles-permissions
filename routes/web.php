...
Route::middleware('permission:store permissions')->post('/permission/store', [App\Http\Controllers\PermissionController::class, 'store'])->name('permission.store');
...
Route::middleware('permission:update permissions')->post('/permission/{id}', [App\Http\Controllers\PermissionController::class, 'update'])->name('permission.update');
