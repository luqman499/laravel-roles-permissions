...
////with middleware
////// Permissions Routes
//Route::middleware('permission:view permission')->get('/permission', [App\Http\Controllers\PermissionController::class,'index'])->name('permission.index');
//Route::middleware('permission:create permission')->get('/permission/create', [App\Http\Controllers\PermissionController::class, 'create'])->name('permission.create');
//Route::middleware('permission:store permission')->post('/permission/store', [App\Http\Controllers\PermissionController::class, 'store'])->name('permission.store');
//Route::middleware('permission:edit permission')->get('/permission/edit/{id}', [App\Http\Controllers\PermissionController::class, 'edit'])->name('permission.edit');
//Route::middleware('permission:update permission')->post('/permission/{id}', [App\Http\Controllers\PermissionController::class, 'update'])->name('permission.update');
//Route::middleware('permission:delete permission')->delete('/permission/{id}', [App\Http\Controllers\PermissionController::class, 'destroy'])->name('permission.destroy');
////
////// Roles Routes
...
//Route::middleware('permission:store roles')->post('/roles/store', [App\Http\Controllers\RoleController::class, 'store'])->name('roles.store');
//Route::middleware('permission:edit roles')->get('/roles/edit/{id}', [App\Http\Controllers\RoleController::class, 'edit'])->name('roles.edit');
//Route::middleware('permission:update roles')->post('/roles/{id}', [App\Http\Controllers\RoleController::class, 'update'])->name('roles.update');
...
//Route::middleware('permission:create articles')->get('articles/create', [App\Http\Controllers\ArticleController::class, 'create'])->name('articles.create');
//Route::middleware('permission:store articles')->post('articles/store', [App\Http\Controllers\ArticleController::class, 'store'])->name('articles.store');
...
//Route::middleware('permission:update articles')->post('articles/{id}', [App\Http\Controllers\ArticleController::class, 'update'])->name('articles.update');
